...
>
>Всё содержание этого репозитория, включая этот файл, создано автором единолично без привлечения сторонних лиц, нейросетей или их решений, что он пытается доказать в том числе комментированием в нескольких решениях, размещённых в отдельной папке. Там, где автор специально не ограничивается только своими знаниями и способностями (например, чтобы показать умение находить информацию), это указано явно.
